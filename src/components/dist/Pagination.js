...
var Pagination = function (_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(PaginationDiv, null, pageNumbers.map(function (number) { return (react_1["default"].createElement(Pagi, { key: number, className: 'page-item' },
